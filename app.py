...
def apply_security_headers(response):
    ...
    csp = (
        ...
        "connect-src 'self' https://www.gstatic.com https://cdn.jsdelivr.net https://*.googleapis.com https://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.firebaseapp.com; "
